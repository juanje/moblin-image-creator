#!/bin/bash
#########################################################################################
# pkg-cp.sh : Copies the source files for a package to inside a specified
#             workspace (i.e. chroot jail) and using src from the
#             the package-meta-data and pristine-release-files dirs.
#
# Usage:
#   pkg-cp.sh WORKSPACE_DIR PACKAGE_NAME [PACKAGE_META_DATA_DIR] [PRISTINE_SRC_DIR]
#
#########################################################################################
