...
/usr/sbin/chroot ${workspace_dir} rpmbuild -bs /usr/src/packages/SPECS/${pkg_name}.spec
/usr/sbin/chroot ${workspace_dir} rpmbuild -bb /usr/src/packages/SPECS/${pkg_name}.spec
