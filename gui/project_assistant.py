...
class projectAssistant(object):
    ...
    def create_project_page(self):
        ...
        projectPageTable.attach(self.projectNameEntry, 1, 2, 0, 1, gtk.EXPAND|gtk.FILL, 0, 0, 0)
        projectPageTable.attach(projectDescLabel, 0, 1, 1, 2, 0, 0)
        projectPageTable.attach(self.projectDescEntry, 1, 2, 1, 2, gtk.EXPAND|gtk.FILL, 0, 0, 0)
        projectPageTable.attach(projectPathLabel, 0, 1, 2, 3, 0, 0)
        projectPageTable.attach(projectPath, 1, 2, 2, 3, gtk.EXPAND|gtk.FILL, 0, 0, 0)
        projectPageTable.attach(projectPlatformLabel, 0, 1, 3, 4, 0, 0)
        projectPageTable.attach(self.projectPlatformCombo, 1, 2, 3, 4, gtk.EXPAND|gtk.FILL, 0, 0, 0)
        projectPageTable.attach(projectPlatformDescLabel, 0, 1, 4, 5, 0, 0)
        projectPageTable.attach(projectPlatformDescText, 1, 2, 4, 5, gtk.EXPAND|gtk.FILL, 0, 0, 0)
